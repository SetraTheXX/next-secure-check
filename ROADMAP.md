...
- [ ] [Issue #12](https://github.com/SetraTheXX/next-secure-check/issues/12) - Add the QA-reviewed terminal demos to the README; visual review passed at `a55d538`, and the follow-up fixture content-integrity guard is awaiting QA re-review before PR #37 can merge. Real-user feedback and accuracy evidence remain open follow-ups. See [demo sources, assets, and review record](./docs/demo/README.md).
