...
- [x] [Issue #12](https://github.com/SetraTheXX/next-secure-check/issues/12) - Add the QA-reviewed terminal demos to the README; QA approved the current CLI and init recordings at `a55d538`. Real-user feedback and accuracy evidence remain open follow-ups. See [demo sources, assets, and review record](./docs/demo/README.md).
