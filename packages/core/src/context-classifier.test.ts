...
describe("classifyFileContext", () => {
  it.each([
    ...
    ["packages/ui/src/button.tsx", "app-code"],
    ...
    ["stories/Button.stories.tsx", "example-code"],
    ["playground/app/page.tsx", "example-code"],
    ["demo/app/page.tsx", "example-code"],
    ...
    ["test/fixtures/vulnerable/app/page.tsx", "template-code"],
    ["__fixtures__/frameworks/next-app/page.tsx", "template-code"],
    ["fixtures/frameworks/next-app/page.tsx", "template-code"],
    ["registry/default/button.tsx", "template-code"],
    ["apps/v4/registry/default/button.tsx", "template-code"],
    ["packages/ui/registry/button.tsx", "template-code"],
    ["packages/shadcn/test/fixtures/default/button.tsx", "template-code"],
